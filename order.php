...
while($row_cart = mysqli_fetch_array($run_cart)){
    ...
    $insert_customer_order = "insert into customer_orders (customer_id,product_id,due_amount,invoice_no,Tid,qty,size,order_date,order_status) values ('$customer_id','$pro_id','$sub_total','$invoice_no','$Tid','$pro_qty','$pro_size',NOW(),'$status')";
